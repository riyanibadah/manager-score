...
function TractorSupplyIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 33.01 32.04" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
      <polygon points="8.99 30.67 26.98 24.54 33.01 1.29 0 1.29 8.99 30.67 8.99 30.67" fill="#D20000" />
      <path
        fill="#FFFFFF"
...
function WellsFargoIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
      <rect width="24" height="24" fill="#D71E28" />
      <path
        fill="#FFFFFF"
